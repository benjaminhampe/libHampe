...
#ifndef _IRR_COMPILE_WITH_SFML_
	#define _IRR_COMPILE_WITH_SFML_
...
// #define _IRR_COMPILE_WITH_IRRKLANG_
// #define _IRR_COMPILE_WITH_SDL_MIXER_
// #define _IRR_COMPILE_WITH_PORTAUDIO_
// #define _IRR_COMPILE_WITH_OPENAL_
// #define _IRR_COMPILE_WITH_ALSA_
// #define _IRR_COMPILE_WITH_JACK_
// #define _IRR_COMPILE_WITH_GSTREAMER_
// #define _IRR_COMPILE_WITH_PULSEAUDIO_
// #define _IRR_COMPILE_WITH_WINMM_

/// uses SFML Audio library for loading and saving various audio-formats ( ogg, flac, wav, mp3? )
#ifdef _IRR_COMPILE_WITH_SFML_
    #include <SFML/System.hpp>
    #include <SFML/Audio.hpp>
#endif

#ifdef _IRR_COMPILE_WITH_ALSA_
	#include <alsa/asoundlib.h>
#endif

#ifdef _IRR_COMPILE_WITH_IRRKLANG_
    #include <irrKlang.h>
#endif

#ifdef _IRR_COMPILE_WITH_PORTAUDIO_
    #include <portaudio.h>
#endif

#ifdef _IRR_COMPILE_WITH_SDL_MIXER_
	# include <SDL/SDL.h>
...
namespace irr
{
	...
	template <class T>
	core::vector2d<T> getArrayMinMax( const core::array<T>& _array )
	{
	...
	namespace sfx
	{
		...
		bool createFilledPath( scene::SMeshBuffer* buffer, const core::dimension2df& size, const core::array<f32>& points, const core::vector2df& y_range, video::IColorGradient* gradient, const core::vector3df& offset = core::vector3df(0,0,0) );
		...
		core::vector2df getFFTSpectrumMinMaxValue(	sfx::FourierTransformRtoC& fft_calc, const sf::SoundBuffer& buffer, u32 TimeStamps, s32 channel_index = 0 );
