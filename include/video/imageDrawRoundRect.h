...
#ifndef __IRR_EXT_DRAW_BRESENHAM_ROUND_RECT_TO_SOFTWARE_IMAGE_H__
#define __IRR_EXT_DRAW_BRESENHAM_ROUND_RECT_TO_SOFTWARE_IMAGE_H__
...
#endif // __IRR_EXT_DRAW_BRESENHAM_ROUND_RECT_TO_SOFTWARE_IMAGE_H__
