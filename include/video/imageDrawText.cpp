...
namespace video
{
...

	{
		...
		{
			#ifdef _DEBUG
			printf(  "drawText() - Invalid pointer to IImage\n" );
			#endif // _DEBUG
			return false;
		}
		...
		{
			#ifdef _DEBUG
			printf(  "drawText() - Invalid pointer to IGUIEnvironment\n" );
			#endif // _DEBUG
			return false;
		}
		...
		{
			#ifdef _DEBUG
			printf(  "drawText() - Cant draw outside destination Image ( x coord too big )\n");
			#endif // _DEBUG
			return false;
		}
		...
		{
			#ifdef _DEBUG
			printf(  "drawText() - Cant draw outside destination Image ( y coord too big )\n");
			#endif // _DEBUG
			return false;
		}
		...
		{
			#ifdef _DEBUG
			printf(  "drawText() - Could not create image, abort\n" );
			#endif // _DEBUG
			return false;
		}
		...
		{
			#ifdef _DEBUG
			printf(  "drawText() - Invalid pointer to IVideoDriver, abort\n" );
			#endif // _DEBUG
			return false;
		}
